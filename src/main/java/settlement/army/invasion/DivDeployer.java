...
final class DivDeployer {
	...
	public static Div deploy(ArrayList<WDivGeneration> divs, InvasionSpot spot) {
		if (divs.size() == 0)
			return null;
	...
	private static boolean place(int sx, int sy, WDivGeneration d, Div div, DIR spotdir) {
