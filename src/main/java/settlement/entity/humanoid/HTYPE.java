...
public final class HTYPE extends INFO implements INDEXED {
	...
	public final static HTYPE SUBJECT = new HTYPE(
			HCLASS.CITIZEN,
	...
	public final static HTYPE RETIREE = new HTYPE(
			HCLASS.CITIZEN,
	...
	public final static HTYPE RECRUIT = new HTYPE(
			HCLASS.CITIZEN,
	...
	public final static HTYPE STUDENT = new HTYPE(
			HCLASS.CITIZEN,
			...
			true, false, false, new ColorImp(20,8,16));
	public final static HTYPE PRISONER = new HTYPE(
			HCLASS.OTHER,
	...
	public final static HTYPE TOURIST = new HTYPE(
			HCLASS.OTHER,
	...
	public final static HTYPE RIOTER = new HTYPE(
			HCLASS.OTHER,
			...
			false, false, true, new ColorImp(30,1,1));
	public final static HTYPE DERANGED = new HTYPE(
			HCLASS.OTHER,
	...
	public final static HTYPE SLAVE = new HTYPE(
			HCLASS.SLAVE,
	...
	public final static HTYPE CHILD = new HTYPE(
			HCLASS.CHILD,
	...
	HTYPE(HCLASS c, CharSequence name, CharSequence names, CharSequence desc, boolean player, boolean works, boolean hostile, COLOR color){
		this(c, name, names, desc, player, works, hostile, player, color);
	}
	
	HTYPE(HCLASS c, CharSequence name, CharSequence names, CharSequence desc, boolean player, boolean works, boolean hostile, boolean visible, COLOR color){
