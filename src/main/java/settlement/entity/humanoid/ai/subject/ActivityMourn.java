...
final class ActivityMourn extends Activity{

	private static CharSequence ¤¤mourning = "Mourning old friend";
	...
	private final Resumer start = new Resumer(¤¤mourning) {
		
		@Override
		public AISubActivation setAction(Humanoid a, AIManager d) {
			return AI.SUBS().walkTo.service(a, d, ROOMS().graveServiceSpots, 200);
		}
	...
	private final Resumer mourn = new Resumer(¤¤mourning) {
