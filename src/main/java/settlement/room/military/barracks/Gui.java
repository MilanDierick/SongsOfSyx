...
final class Gui extends UIRoomModuleImp<BarracksInstance, ROOM_BARRACKS>{
	...
	protected Gui(ROOM_BARRACKS blueprint) {
		super(blueprint);
	}

	@Override
	protected void appendPanel(GuiSection section, GGrid g, GETTER<BarracksInstance> getter, int x1, int y1) {
	...
	@Override
	protected void hover(GBox box, BarracksInstance i) {
		// TODO Auto-generated method stub
		super.hover(box, i);
	}
	
	@Override
	protected void problem(BarracksInstance i, GBox box) {
		// TODO Auto-generated method stub
		super.problem(i, box);
	}
