...
public final class ROOM_PRISON extends RoomBlueprintIns<PrisonInstance> implements ROOM_EMPLOY_AUTO, PUNISHMENT_SERVICE{
	...
	public COORDINATE registerPrisoner() {
	...
	public boolean autoEmploy(Room r) {
		return ((PrisonInstance)r).autoEmploy;
	}

	@Override
	public void autoEmploy(Room r, boolean b) {
		((PrisonInstance)r).autoEmploy = b;
	}	
