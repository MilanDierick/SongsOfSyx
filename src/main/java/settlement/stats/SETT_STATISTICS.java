...
public interface SETT_STATISTICS {
	...
	static class SettStatistics implements SETT_STATISTICS{
		...
		SettStatistics(Init init, INFO info){
		...
		void inc(HCLASS c, Race r, int am, int divi) {
