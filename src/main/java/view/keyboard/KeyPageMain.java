...
public class KeyPageMain extends KeyPage{
	...
	public final Key THRONE = new Key("THRONE", D.g("Center"), D.g("ThroneD", "Center the map on the throne or the capitol"), this, KEYCODES.KEY_LEFT_CONTROL, KEYCODES.KEY_A);
	...
	public final Key SPEED1 = new Key("SPEED1", D.g("speed-normal"),D.g("speed-normalD", "Sets 1x speed"),this,  KEYCODES.KEY_2);
