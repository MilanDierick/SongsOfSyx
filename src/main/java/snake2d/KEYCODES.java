...
public final class KEYCODES {
	...
	private final static Bitmap1D exists; 
	...
	static {
		...
		ArrayList<Integer> alll = new ArrayList<>(am);
		exists = new Bitmap1D(lastCode(), false);
